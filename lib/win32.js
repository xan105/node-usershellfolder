...
const win32 = {
  ...
  user: {
    appData: regQueryStringValueAndExpand("HKCU",userShellFolders,"AppData") || process.env['APPDATA'],
    localAppData: regQueryStringValueAndExpand("HKCU",userShellFolders,"Local AppData") || process.env['LOCALAPPDATA'],
    home: homedir() || process.env['USERPROFILE'],
    desktop: regQueryStringValueAndExpand("HKCU",userShellFolders,"Desktop") || 
             join(process.env['USERPROFILE'],"Desktop"),
    documents: regQueryStringValueAndExpand("HKCU",userShellFolders,"{F42EE2D3-909F-4907-8871-4C22FC0BF756}") || //Win10
               regQueryStringValueAndExpand("HKCU",userShellFolders,"Personal") || 
               join(process.env['USERPROFILE'],"Documents"),
    music: regQueryStringValueAndExpand("HKCU",userShellFolders,"{A0C69A99-21C8-4671-8703-7934162FCF1D}") || //Win10
           regQueryStringValueAndExpand("HKCU",userShellFolders,"My Music") || 
           join(process.env['USERPROFILE'],"Music"),
    pictures: regQueryStringValueAndExpand("HKCU",userShellFolders,"{0DDD015D-B06C-45D5-8C4C-F59713854639}") || //Win10
              regQueryStringValueAndExpand("HKCU",userShellFolders,"My Pictures") || 
              join(process.env['USERPROFILE'],"Pictures"),
    videos: regQueryStringValueAndExpand("HKCU",userShellFolders,"{35286A68-3C57-41A1-BBB1-0EAE73D76C95}") || //Win10
            regQueryStringValueAndExpand("HKCU",userShellFolders,"My Video") || 
            join(process.env['USERPROFILE'],"Videos"),
    download: regQueryStringValueAndExpand("HKCU",userShellFolders,"{7D83EE9B-2244-4E70-B1F5-5393042AF1E4}") || //Win10
    ...
    savegame: regQueryStringValueAndExpand("HKCU",userShellFolders,"{4C5C32FF-BB9D-43b0-B5B4-2D72E54EAAA4}") || 
